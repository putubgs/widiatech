...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="text-center space-y-8">
            ...
            <div className="flex justify-center">
              <Button
                className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-lg px-8 py-6 rounded-full transition-all duration-300 transform hover:scale-105"
                asChild
              >
                <Link
                  href="https://wa.me/6282236883438"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-gray-800/50 border-purple-500/20 hover:border-purple-500/50 transition-all duration-300 transform hover:scale-105">
              <CardContent className="pt-8">
                ...
                <h3 className="text-2xl font-bold mb-4 text-center text-white">
                  {t.services.websiteExpress.title}
                </h3>
                <p className="text-gray-300 mb-6 text-center leading-relaxed">
                  {t.services.websiteExpress.description}
                </p>
                <p className="text-3xl font-bold text-center bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent mb-6">
                  {t.services.websiteExpress.price}
                </p>
            ...
            <Card className="bg-gray-800/50 border-purple-500/20 hover:border-purple-500/50 transition-all duration-300 transform hover:scale-105">
              <CardContent className="pt-8">
                ...
                <h3 className="text-2xl font-bold mb-4 text-center text-white">
                  {t.services.customApp.title}
                </h3>
                <p className="text-gray-300 mb-6 text-center leading-relaxed">
                  {t.services.customApp.description}
                </p>
                <p className="text-3xl font-bold text-center bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent mb-6">
                  {t.services.customApp.price}
                </p>
                <ul className="text-sm text-gray-200 space-y-2">
            ...
            <Card className="bg-gray-800/50 border-purple-500/20 hover:border-purple-500/50 transition-all duration-300 transform hover:scale-105">
              <CardContent className="pt-8">
                ...
                <h3 className="text-2xl font-bold mb-4 text-center text-white">
                  {t.services.digitalConsultation.title}
                </h3>
                <p className="text-gray-300 mb-6 text-center leading-relaxed">
                  {t.services.digitalConsultation.description}
                </p>
                <p className="text-3xl font-bold text-center bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent mb-6">
                  {t.services.digitalConsultation.price}
                </p>
                <ul className="text-sm text-gray-200 space-y-2">
                  {t.services.digitalConsultation.features.map(
                    (feature, index) => (
                      <li key={index} className="flex items-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
      ...
      <section
        id="cta"
        className="py-24 px-4 bg-gradient-to-r from-purple-800 via-pink-700 to-purple-800 scroll-mt-20 relative overflow-hidden"
      >
      ...
      <footer
        id="kontak"
        className="py-16 px-4 bg-gray-900 border-t border-white/10"
      >
        <div className="container mx-auto md:px-10 w-full">
          ...
          <div className="text-center mt-12 text-sm text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} WidiaTech. {t.footer.rights}
            </p>
          </div>
        </div>
      </footer>
